...
@section('content')
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      let sticky_action_el = document.querySelector("#sticky-action");
      ...
      <div id="sidebar" class="col-auto ps-4 py-4 border-end border-1" style="width: 200px;">
        <div class="sticky-top" id="sticky-fix">
          ...
          <div class="row border-bottom pb-4 mb-4">
            ...
            <div class="col">
              <p class="m-0 p-0 fw-bold text-break">{{ 'Teweknisi' }}</p>
        ...
        <div class="row border-bottom border-end bg-white py-4 px-2">
          ...
          <div class="col pt-4">
            <div class="--sticky-table-item row px-3 sticky-top" id="sticky-action" style="z-index: 1;">
              ...
              <button type="button" class="btn btn-danger py-3 fw-bold"  data-bs-toggle="modal" data-bs-target="#modal-tolak-permintaan">
          ...
          <div class="col pt-4 d-none">
            <div class="row px-3 sticky-top" id="sticky-fix" style="z-index: 1;">
